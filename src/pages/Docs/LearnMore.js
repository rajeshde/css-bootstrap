const LearnMore = () => (
  <div className="relative flex justify-center items-center bg-gradient-to-r from-indigo-600 to-lightBlue-500 px-6 sm:px-4 py-2">
    <svg
      fill="none"
      viewBox="0 0 848 513"
      className="hidden sm:block absolute right-2/3 transform -translate-x-150"
    >
      <path
        fill="#fff"
        fill-opacity=".1"
    ...
    <svg
      fill="none"
      viewBox="0 0 848 513"
      class="hidden sm:block absolute left-1/2 transform translate-x-20"
    >
      <path
        fill="#fff"
        fill-opacity="0.1"
